...
class SCMGenerator:
    ...
    def __init__(self, all_functions: Dict[str, Callable], seed: int, samples_shape: tuple, noise_std: float):
        """
    ...
    def create_scm_from_graph(self, graph: nx.DiGraph, possible_functions: List[str], exo_distribution: Callable,
        ...
        for n in graph.nodes:
            ...
            if graph.nodes[n]['type'] == 'endo':
                ...
                scm.add_endogenous_var(n, self.all_functions[current_function](parents=parents, samples_shape=self.samples_shape, noise_std=self.noise_std), {p: p for p in parents})
            else:
